...
(	
	...
	--Khóa ngoại tới tài khoản tài xế
	CONSTRAINT FK_AD_TK FOREIGN KEY (TaiKhoan) REFERENCES TaiKhoan(TaiKhoan) ON DELETE CASCADE
)
GO
...
(	
	...
	Ten NVARCHAR(30) NOT NULL,
	--Khóa ngoại tới tài khoản tài xế
	CONSTRAINT FK_NV_TK FOREIGN KEY (TaiKhoan) REFERENCES TaiKhoan(TaiKhoan) ON DELETE CASCADE
)
GO
...
CREATE INDEX ID_ADMIN_TK ON Admin(TaiKhoan);
CREATE INDEX ID_NHANVIEN_TK ON NhanVien(TaiKhoan);
